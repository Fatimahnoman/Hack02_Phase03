#!/usr/bin/env python3
"""
Debug script to check which database file is being used after fixing the paths.
"""
...
if 'backend.src.core.database' in sys.modules:
    del sys.modules['backend.src.core.database']
...
importlib.reload(backend.src.core.config)
...
def main():
    print("Checking database configuration after path fix...")
